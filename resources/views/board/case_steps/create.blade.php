...
<div class="page-body">
	<div class="container-xl">
		<div class="row row-deck row-cards">
			<div class="col-md-12">
				<form class="card" method='POST' action='{{ route('board.case_steps.store') }}' >
					@csrf
					...
					<div class="card-body">
						<div class="mb-3">
							...
							<div>
								<input type="text" class="form-control @error('step_rank_ar') is-invalid @enderror " name='step_rank_ar' value="{{ old('step_rank_ar') }}" >
								@error('step_rank_ar')
						...
						<div class="mb-3">
							...
							<div>
								<input type="text" class="form-control @error('step_rank_en') is-invalid @enderror " name='step_rank_en' value="{{ old('step_rank_en') }}" >
								@error('step_rank_en')
								<small class="form-hint text-danger"> {{ $message }} </small>
								@enderror
							</div>
