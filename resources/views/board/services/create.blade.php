			...
			<div class="col-md-12">
				<form class="card" method='POST' action='{{ route('board.services.store') }}' enctype="multipart/form-data" >
					...
					<div class="card-header bg-primary">
						<h3 class="card-title text-white"> إضافه جديد </h3>
					</div>
					<div class="card-body">
						...
						<div class="mb-3">
							<label class="form-label required"> عنون الخدمه بالعربيه </label>
							<div>
						...
						<div class="mb-3">
							<label class="form-label required"> عنون الخدمه بالانجليزيه </label>
							<div>
