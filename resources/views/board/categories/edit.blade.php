				...
				<form class="card" method='POST' action='{{ route('board.categories.update'  , $category ) }}' enctype="multipart/form-data" >
					...
					<div class="card-body">
						...
						<div class="mb-3">
							...
							<div>
								<input type="text" class="form-control @error('title_ar') is-invalid @enderror " name='title_ar' value="{{ $category->getTranslation('title' , 'ar') }}" >
								@error('title_ar')
								<small class="form-hint text-danger"> {{ $message }} </small>
								@enderror
							</div>
						...
						<div class="mb-3">
							...
							<div>
								<input type="text" class="form-control @error('title_en') is-invalid @enderror " name='title_en' value="{{ $category->getTranslation('title' , 'en') }}" >
								@error('title_en')
								<small class="form-hint text-danger"> {{ $message }} </small>
								@enderror
							</div>
