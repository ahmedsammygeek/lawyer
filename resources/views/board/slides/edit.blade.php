	...
	<div class="container-xl">
		<div class="row g-2 align-items-center">
			...
			<div class="col-auto ms-auto d-print-none">
				<div class="btn-list">
					<a href="{{ route('board.slides.index') }}" class="btn btn-primary d-none d-sm-inline-block" >
...
<div class="page-body">
	<div class="container-xl">
		<div class="row row-deck row-cards">
			<div class="col-md-12">
				<form class="card" method='POST' action='{{ route('board.slides.update' , $slide ) }}' enctype="multipart/form-data" >
					@csrf
					@method('PATCH')
					<div class="card-header bg-primary">
						<h3 class="card-title text-white"> تعديل الشريحه  </h3>
					</div>
					<div class="card-body">
						...
						<div class="mb-3">
							...
							<div>
								<input type="text" class="form-control @error('title_en') is-invalid @enderror " name='title_en' value="{{ $slide->getTranslation('title' , 'en') }}" >
								@error('title_en')
								<small class="form-hint text-danger"> {{ $message }} </small>
								@enderror
							</div>
						...
						<div class="mb-3">
							...
							<div>
								<input type="text" class="form-control @error('subtitle_ar') is-invalid @enderror " name='subtitle_ar' value="{{ $slide->getTranslation('subtitle' , 'ar') }}" >
								@error('subtitle_ar')
								<small class="form-hint text-danger"> {{ $message }} </small>
								@enderror
							</div>
						...
						<div class="mb-3">
							...
							<div>
								<input type="text" class="form-control @error('subtitle_en') is-invalid @enderror " name='subtitle_en' value="{{ $slide->getTranslation('subtitle' , 'en') }}" >
								@error('subtitle_en')
								<small class="form-hint text-danger"> {{ $message }} </small>
								@enderror
							</div>
						...
						<div class="mb-3">
							...
							<div>
								<label class="form-check">
									<input class="form-check-input" name='is_active' type="checkbox" {{ $slide->is_active == 1 ? 'checked' : '' }}>
						...
						<div class="mb-3">
							...
							<div>
								<img src="{{ Storage::url('slides/'.$slide->image) }}" alt="">
							</div>
						</div>
					</div>
					<div class="card-footer text-end">
						<div class='d-flex' >
							<a href="{{ route('board.slides.index') }}" class="btn btn-link"> تراجع </a>
