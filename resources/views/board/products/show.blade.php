					...
					<div class="card-body">
						<table class="table table-responsive table-bordered">
							<tbody>
								...
								<tr>
									<th> تفاصيل المنتج بالعربيه </th>
									<td> {{ $product->getTranslation('content' , 'ar') }}  </td>
								</tr>

								<tr>
									<th> تفاصيل المنتج بالانجليزيه </th>
								...
								<tr>
									...
									<td> 
										<a class="avatar" data-fslightbox="gallery" href="{{ Storage::url('products/'.$product->image) }}">
											<img  src="{{ Storage::url('products/'.$product->image) }}" alt="">
										</a>
									</td>
								</tr>	
								<tr>
									<th> صوره البانر الرئيسيه </th>
									<td> 
										<a class="avatar" data-fslightbox="gallery" href="{{ Storage::url('products/'.$product->banner) }}">
											<img  src="{{ Storage::url('products/'.$product->banner) }}" alt="">
										</a>
									</td>
								</tr>								
							</tbody>
