				...
				<form class="card" method='POST' action='{{ route('board.products.update' , $product) }}' enctype="multipart/form-data" >
					...
					<div class="card-body">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="mb-3">
									<label class="form-label required"> صوره البانر  </label>
									<div>
							...
							<div class="col-md-4">
								<div class="mb-3">
									<label class="form-label required"> اسم المنتج بالعربيه </label>
									<div>
							...
							<div class="col-md-4">
								<div class="mb-3">
									<label class="form-label required"> اسم المنتج بالانجليزيه </label>
									<div>
							...
							<div class="col-md-3">
								<div class="mb-3">
									<label class="form-label required"> السعر بعد الخصم </label>
									<div>
										<input type="number" class="form-control @error('discount') is-invalid @enderror " name='discount' value="{{ $product->discount }}" >
										@error('discount')
										<small class="form-hint text-danger"> {{ $message }} </small>
										@enderror
									</div>
							...
							<div class="col-md-3">
								<div class="mb-3">
									...
									<div>
										<input type="number" class="form-control @error('rate') is-invalid @enderror " name='rate' value="{{ $product->rate }}" >
										@error('rate')
										<small class="form-hint text-danger"> {{ $message }} </small>
										@enderror
									</div>
							...
							<div class="col-md-12">
								<div class="mb-3">
									<label class="form-label required">  تفاصيل المشروع بالعربيه </label>
									<div>
										<textarea name="content_ar" id="" class="form-control" cols="30" rows="5"> {{ $product->getTranslation('content' , 'ar') }} </textarea>
										@error('content_ar')
										<small class="form-hint text-danger"> {{ $message }} </small>
										@enderror
									</div>
							...
							<div class="col-md-12">
								<div class="mb-3">
									<label class="form-label required">  تفاصيل المشروع بالانجليزيه </label>
									<div>
										<textarea name="content_en" id="" class="form-control" cols="30" rows="5"> {{ $product->getTranslation('content' , 'en') }} </textarea>
										@error('content_en')
										<small class="form-hint text-danger"> {{ $message }} </small>
										@enderror
									</div>
						...
						<div class="mb-3">
							...
							<div>
								<label class="form-check">
									<input class="form-check-input" name='is_active' type="checkbox" @checked($product->is_active) >
									<span class="form-check-label"> السماح بالعرض </span>
								</label>
							</div>
						</div>
						<div class="mb-3">
							<label class="form-label"> عرض داخل العروض </label>
							<div>
								<label class="form-check">
									<input class="form-check-input" name='is_offer' type="checkbox" @checked($product->is_offer) >
									<span class="form-check-label"> السماح بالعرض </span>
								</label>
							</div>
						</div>
						<div class="mb-3">
							<label class="form-label"> صوره المنتج  الحاليه </label>
							<div>
						...
						<div class="mb-3">
							<label class="form-label"> الصوره البانر الحاليه </label>
							<div>
								<img class="img-thumbnail" src="{{ Storage::url('products/'.$product->banner) }}" alt="">
							</div>
						</div>
