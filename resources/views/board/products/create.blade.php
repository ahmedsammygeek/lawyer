				...
				<form class="card" method='POST' action='{{ route('board.products.store') }}' enctype="multipart/form-data" >
					...
					<div class="card-body">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="mb-3">
									...
									<div>
										<textarea name="content_ar" id="" class="form-control" cols="30" rows="5"> {{ old('content_ar') }} </textarea>
										@error('content_ar')
										<small class="form-hint text-danger"> {{ $message }} </small>
										@enderror
									</div>
							...
							<div class="col-md-12">
								<div class="mb-3">
									...
									<div>
										<textarea name="content_en" id="" class="form-control" cols="30" rows="5"> {{ old('content_en') }} </textarea>
										@error('content_en')
										<small class="form-hint text-danger"> {{ $message }} </small>
										@enderror
									</div>
						...
						<div class="mb-3">
							...
							<div>
								<label class="form-check">
									<input class="form-check-input" name='is_offer' type="checkbox" >
									<span class="form-check-label"> السماح بالعرض </span>
								</label>
							</div>
						</div>
