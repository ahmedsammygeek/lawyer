            ...
            <table class="table">
                ...
                <tbody class="table-tbody">
                    ...
                    <tr>
                        <td> {{ $i++ }} </td>
                        <td>
                            <a class="avatar" data-fslightbox="gallery" href="{{ Storage::url('slides/'.$slide->image) }}">
                        ...
                        <td class='row g-2 align-items-center' >
                            <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                                <a href="{{ route('board.slides.show' , $slide) }}" class="btn btn-primary w-100 btn-icon" aria-label="Facebook">
                            ...
                            <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                                <a href="{{ route('board.slides.edit' , $slide ) }}" class="btn btn-warning w-100 btn-icon" aria-label="Facebook">
                            ...
                            <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                                <a class="btn btn-danger w-100 btn-icon" wire:click="$emit('confirmDeletion' , {{ $slide->id }} )" aria-label="Facebook">
