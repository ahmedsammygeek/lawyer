        ...
        <div id="table-default" class="table-responsive">
            <table class="table">
                ...
                <tbody class="table-tbody">
                    ...
                    <tr>
                        <td> {{ $i++ }} </td>
                        <td> {{ $certificate->getTranslation('content' , 'ar') }} </td>
                        <td> {{ $certificate->getTranslation('content' , 'en') }} </td>
                        <td>
                            @switch($certificate->is_active)
                            @case(1)
                        ...
                        <td class='row g-2 align-items-center' >
                            ...
                            <a href="{{ route('board.certificates.show' , $certificate) }}" class="btn btn-primary w-100 btn-icon" aria-label="Facebook">
                            ...
                            <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                                <a href="{{ route('board.certificates.edit' , $certificate ) }}" class="btn btn-warning w-100 btn-icon" aria-label="Facebook">
                            ...
                            <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                                <a class="btn btn-danger w-100 btn-icon" wire:click="$emit('confirmDeletion' , {{ $certificate->id }} )" aria-label="Facebook">
