        ...
        <div id="table-default" class="table-responsive">
            <table class="table">
                ...
                <tbody class="table-tbody">
                    ...
                    <tr>
                        <td> {{ $i++ }} </td>
                        <td> {{ $step->getTranslation('title' , 'ar') }} </td>
                        <td> {{ $step->getTranslation('title' , 'en') }} </td>
                        <td> {{ $step->created_at }} <span class="text-muted">{{ $step->created_at->diffForHumans() }}</span> </td>
                        <td> {{ $step->user?->name }} </td>

                        <td class='row g-2 align-items-center' >
                            <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                                <a href="{{ route('board.case_steps.show' , $step) }}" class="btn btn-primary w-100 btn-icon" aria-label="Facebook">
                            ...
                            <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                                <a href="{{ route('board.case_steps.edit' , $step ) }}" class="btn btn-warning w-100 btn-icon" aria-label="Facebook">
                            ...
                            <div class='col-6 col-sm-4 col-md-2 col-xl-auto '>
                                <a class="btn btn-danger w-100 btn-icon" wire:click="$emit('confirmDeletion' , {{ $step->id }} )" aria-label="Facebook">
